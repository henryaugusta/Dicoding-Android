package com.feylabs.navigation
...
class CategoryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnCategoryTech.setOnClickListener {
            val toTech = CategoryFragmentDirections.actionCategoryFragmentToDetailCategoryFragment()
            toTech.name="Tech"
            toTech.stock="90"
            view.findNavController().navigate(toTech)
        }
    }
