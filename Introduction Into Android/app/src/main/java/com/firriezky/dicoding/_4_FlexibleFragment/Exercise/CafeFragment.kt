...
import com.firriezky.dicoding.MainActivity
import com.firriezky.dicoding.R
import com.firriezky.dicoding.databinding.FragmentCafeBinding
...
class CafeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentCafeBinding.bind(view)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnKeMasjid.setOnClickListener {
            (activity as SocialActivity).changeFragment(
                MasjidFragment(),SocialActivity.MOSQUE
            )
        }
    }
